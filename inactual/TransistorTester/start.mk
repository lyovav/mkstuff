...
MKFILES = ./Makefile ./start.mk ./fin.mk
...
ifeq ($(WITH_LCD_ST7565),1)
OBJECTS += $(ObjD)/font.o $(ObjD)/lcd-draw.o
endif
OBJECTS += $(ObjD)/swuart.o $(ObjD)/wait1000ms.o 
ifneq ($(INHIBIT_SLEEP_MODE),1)
OBJECTS += $(ObjD)/sleep_5ms.o
endif
OBJECTS += $(ObjD)/ReadADC.o $(ObjD)/wait_for_key_ms.o $(ObjD)/RefVoltage.o
ifneq ($(PARTNO),m8)
OBJECTS += $(ObjD)/get_log.o
endif
OBJECTS += $(ObjD)/main.o $(ObjD)/CheckPins.o $(ObjD)/ChargePin10ms.o $(ObjD)/EntladePins.o
OBJECTS += $(ObjD)/ReadCapacity.o $(ObjD)/GetRLmultip.o $(ObjD)/Calibrate_UR.o
ifneq ($(PARTNO),m8)
OBJECTS += $(ObjD)/ReadInductance.o $(ObjD)/GetESR.o $(ObjD)/GetVloss.o $(ObjD)/GetFrequency.o $(ObjD)/function_menu.o $(ObjD)/message_key_released.o $(ObjD)/ReadBigCap.o
OBJECTS += $(ObjD)/CheckRotaryEncoder.o $(ObjD)/CalibrationCap.o $(ObjD)/ShowData.o
endif
ifndef USE_EEPROM
OBJECTS +=  $(ObjD)/EE_check_init.o
endif
