...
#ifndef _LCD_Generic_H_
#define _LCD_Generic_H_
...
namespace Generic
{
    ...
    public:
        ...
        */
       void setBacklightPin(uint8_t value, backlight_pol pol) const { }
       ...
       /*!
        ...
        backlight on.
        */
       virtual void setBacklight(uint8_t value) const;
    ...
    protected:
       ...
       mutable uint8_t _displaycontrol; // LCD base control command LCD on/off, blink, cursor
                                        // all commands are "ored" to its contents.
       mutable uint8_t _displaymode;    // Text entry mode to the LCD
       uint8_t _numlines;               // Number of lines of the LCD, initialized with begin()
       uint8_t _cols;                   // Number of columns in the LCD
       backlight_pol _polarity;         // Backlight polarity
       ...
       /*!
        ...
        FOUR_BITS).
        */
       void command(uint8_t value) const;
    ...
    private:
        ...
        */
       virtual size_t write(uint8_t value) const;
    ...
    inline void LCD::noCursor() const
    {
       _displaycontrol &= ~LCD_CURSORON;
       command(LCD_DISPLAYCONTROL | _displaycontrol);
    }

    inline void LCD::cursor() const
    {
       _displaycontrol |= LCD_CURSORON;
       command(LCD_DISPLAYCONTROL | _displaycontrol);
    }
    ...
    inline void LCD::noBlink() const
    {
       _displaycontrol &= ~LCD_BLINKON;
       command(LCD_DISPLAYCONTROL | _displaycontrol);
    }

    inline void LCD::blink() const
    {
       _displaycontrol |= LCD_BLINKON;
       command(LCD_DISPLAYCONTROL | _displaycontrol);
    }
    ...
    inline void LCD::scrollDisplayLeft(void) const
    {
       command(LCD_CURSORSHIFT | LCD_DISPLAYMOVE | LCD_MOVELEFT);
    }

    inline void LCD::scrollDisplayRight(void) const
    {
       command(LCD_CURSORSHIFT | LCD_DISPLAYMOVE | LCD_MOVERIGHT);
    }

    // This is for text that flows Left to Right
    inline void LCD::leftToRight(void) const
    {
    ...
    inline void LCD::rightToLeft(void) const
    {
       _displaymode &= ~LCD_ENTRYLEFT;
       command(LCD_ENTRYMODESET | _displaymode);
    }
    ...
    inline void LCD::noAutoscroll(void) const
    {
       _displaymode &= ~LCD_ENTRYSHIFTINCREMENT;
       command(LCD_ENTRYMODESET | _displaymode);
    }

    inline void LCD::backlight(void) const { setBacklight(255); }
    inline void LCD::noBacklight(void) const { setBacklight(0); }
