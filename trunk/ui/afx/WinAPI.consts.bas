...
Public Const FILE_FLAG_FIRST_PIPE_INSTANCE       As Long = &H80000
...
Public Const FILE_ALL_ACCESS                    As Long = STANDARD_RIGHTS_REQUIRED + SYNCHRONIZE + &H1FF
Public Const FILE_GENERIC_READ                  As Long = STANDARD_RIGHTS_READ + FILE_READ_DATA + FILE_READ_ATTRIBUTES + FILE_READ_EA + SYNCHRONIZE
Public Const FILE_GENERIC_WRITE                 As Long = STANDARD_RIGHTS_WRITE + FILE_WRITE_DATA + FILE_WRITE_ATTRIBUTES + FILE_WRITE_EA + FILE_APPEND_DATA + SYNCHRONIZE
Public Const FILE_GENERIC_EXECUTE               As Long = STANDARD_RIGHTS_EXECUTE + FILE_READ_ATTRIBUTES + FILE_EXECUTE + SYNCHRONIZE
...
Public Const FILE_ATTRIBUTE_VIRTUAL             As Long = &H10000
...
Public Const FILE_ACTION_ADDED                  As Long = &H1
Public Const FILE_ACTION_REMOVED                As Long = &H2
Public Const FILE_ACTION_MODIFIED               As Long = &H3
Public Const FILE_ACTION_RENAMED_OLD_NAME       As Long = &H4
Public Const FILE_ACTION_RENAMED_NEW_NAME       As Long = &H5
Public Const MAILSLOT_NO_MESSAGE                As Long = &HFFFFFFFF
Public Const MAILSLOT_WAIT_FOREVER              As Long = &HFFFFFFFF
...
Public Const FILE_READ_ONLY_VOLUME              As Long = &H80000
Public Const FILE_SEQUENTIAL_WRITE_ONCE         As Long = &H100000
Public Const FILE_SUPPORTS_TRANSACTIONS         As Long = &H200000
Public Const FILE_SUPPORTS_HARD_LINKS           As Long = &H400000
Public Const FILE_SUPPORTS_EXTENDED_ATTRIBUTES  As Long = &H800000
Public Const FILE_SUPPORTS_OPEN_BY_FILE_ID      As Long = &H1000000
Public Const FILE_SUPPORTS_USN_JOURNAL          As Long = &H2000000
